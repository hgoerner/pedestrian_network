...
main_folder_path = r"Z:\_Public\Projekte\IVST\058_FoPS_Fuss\02_Bearbeitung\AP5\13_Wochenanalyse\7Tage\Datengrundlage\Seiten_zusammengefasst\Sa-So_summen"

PLOTTITLE = "Anteil Fußverkehr je Tag\nWochenganglinien Samstag bis Sonntag"
...
ax.yaxis.set_major_locator(FixedLocator([0.1 * i for i in range(0, 91)]))

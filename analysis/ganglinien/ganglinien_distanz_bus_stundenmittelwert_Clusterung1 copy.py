...
PLOTTITLE = 'Anteil Fußverkehr je Stunde\nunterteilt in Umfeldfaktor und Einwohnendendichte\ngemittelt'
LEGENDTITLE = 'Legende'
...
for i, csv_file in enumerate(os.listdir(main_folder_path)):
    ...
    if csv_file.endswith('.csv'):
        ...
        ax.plot(df['start time(ohne Tag)'], df['gleitender_Stundenwert_aus_MW'], color=color_map[csv_file], label=" n="+str(n) )
